...
def main():
    ...
    h5ad_path = "ReplogleWeissman2022_K562_essential.h5ad" 
    outdir = "target_validation_results_essential"
    n_cores = 25  # You can try 53 again with spawn, but 32 is safer
    ensure_dir(outdir)
